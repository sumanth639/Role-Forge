                ...
                <div className="flex gap-3">
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {mode === 'flexible' && <Check size={16} className="text-primary" />}
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {mode === 'strict' && <Check size={16} className="text-primary" />}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Precise and rule-following
                    </p>
                  </button>
                </div>
              </div>
              ...
              <Card className="shadow-elevated">
                <CardHeader className="pb-4">
                  <div className="flex items-start justify-between">
                    <div className={cn('flex h-14 w-14 items-center justify-center rounded-2xl', colorClasses[selectedColor])}>
                      <DynamicIcon
                        name={selectedIcon}
                ...
                <CardContent>
                  <CardDescription className="line-clamp-2">
                    {description || 'Add a description to see it here...'}
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
