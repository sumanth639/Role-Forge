  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background hover:bg-secondary hover:border-muted-foreground/20",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost: "hover:bg-secondary hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        pill: "bg-foreground text-background rounded-full hover:bg-foreground/90 shadow-soft",
        "pill-outline": "border border-border bg-background rounded-full hover:bg-secondary",
        "pill-primary": "bg-primary text-primary-foreground rounded-full hover:bg-primary/90 shadow-soft hover:shadow-card",
      },
      size: {
